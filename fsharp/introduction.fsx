...
let x = 20
let typeOfX = x.GetType()
//typeOfX;; ran separately to double check ways to check types
let y = 20.0
let typeOfY = y.GetType()
//typeOfY;; same as above, ran separately to check
...
// //let x = 100 //THIS STILL ISNT GOING TO WORK SINCE THE SCOPE IS GLOBAL AS OPPOSED TO INSIDE A FUNCTION.
// //LET CAN BE SHADOWED IN THE LOCAL SCOPE BUT NOT OUTSIDE OF THAT.
...
//returns a tuple which is one return with multiple values
//---------------------------------------------------------------
...
let result =
    if 2 = 3 then
        ...
        "math is workng!" //im leaving this like this haha.
